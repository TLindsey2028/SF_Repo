/*
Taken from https://github.com/DouglasCAyers/sfdc-lightning-data-tables-component/blob/master/src/aura/DataTableCmp/DataTableCmpRenderer.js
    ...
    afterRender : function( component, helper ) {
        ...
        var scrollCheckIntervalId = setInterval( $A.getCallback( function() {
            ...
            if ( didScroll && component.isValid() ) {
                ...
                if ( window['scrollY'] >= document.body['scrollHeight'] - window['outerHeight'] - 50 ) {
